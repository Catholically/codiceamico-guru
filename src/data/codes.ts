...
export const referralCodes: ReferralCode[] = [
  {
    ...
    category: 'banche',
    code: 'DA_INSERIRE',
    link: 'https://n26.com/r/DA_INSERIRE',
    bonusInviter: '5€',
    bonusInvited: '0€',
    ...
    howTo: [
      ...
      'Effettua il primo acquisto con la carta (anche 1€)',
      'Riceverai il bonus entro pochi giorni',
    ],
    terms: 'Il bonus viene accreditato dopo il primo acquisto con la carta N26. Valido solo per nuovi clienti.',
    active: true,
    featured: true,
  },
  {
    ...
    category: 'banche',
    code: 'DA_INSERIRE',
    link: 'https://revolut.com/referral/DA_INSERIRE',
    bonusInviter: 'Fino a 50€',
    bonusInvited: 'Fino a 50€',
    description: 'Revolut offre un conto multivaluta con carta fisica e virtuale, cambio valuta in tempo reale, crypto trading e molto altro.',
    howTo: [
      'Clicca sul link di invito',
  ...
  },
  {
    ...
    description: 'Unidata è un operatore di fibra ottica e servizi internet. Programma referral con mese gratuito.',
    howTo: [
      'Contattami per il referral',
      'Ti fornisco nome e cognome per l\'invito',
      'Attiva il servizio Unidata',
      'Entrambi riceviamo 1 mese gratis',
    ],
    terms: 'Referral tramite nome e cognome. Contattami per i dettagli.',
    active: true,
  },
  {
    id: 'eni',
