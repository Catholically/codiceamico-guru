...
export const referralCodes: ReferralCode[] = [
  ...
  },
  {
    ...
    description: 'BBVA Italia: Conto e Carta a 0€ per sempre! Ottieni 10€ con il primo acquisto, 3% di interessi sul saldo e 3% di cashback sugli acquisti per 6 mesi.',
    howTo: [
      ...
      'Effettua il primo acquisto con la carta',
      'Ricevi 10€ + 3% interessi + 3% cashback per 6 mesi!',
    ],
    terms: 'Conto e carta gratuiti per sempre. 3% remunerazione sul saldo e 3% cashback validi per 6 mesi senza fare niente.',
    maxInvites: 20,
    active: true,
    featured: true,
  },
  ...
  },
  {
    ...
    bonusInviter: '5€',
    bonusInvited: '5€',
    description: 'Satispay è l\'app italiana per pagamenti digitali, cashback e risparmi. Usatissima nei negozi fisici. 5€ per ogni amico che inviti!',
    howTo: [
    ...
    terms: 'Bonus 5€ accreditato dopo la registrazione e collegamento conto.',
    active: true,
    featured: true,
  },
  {
